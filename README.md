...
* Type-level vector and matrix dimensions through hmatrix-static
* Transition-matrix multiplication
* Access to a transition distribution for a given state
* Random sampling from a distribution
* Single-step Markov-chain simulation
* Approximate equality helpers for numerical tests
...
The library is in early development. The current API covers the basic finite-state objects and one-step simulation; multi-step dynamics and further Markov-chain analysis are planned.