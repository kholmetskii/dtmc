...
-- at runtime using the environment variable dtmc_bindir.
...
-- environment variable dtmc_libdir.
...
-- using the environment variable dtmc_dynlibdir.
...
-- runtime using the environment variable dtmc_datadir.
...
-- using the environment variable dtmc_sysconfdir.
...
bindir     = "/Users/a123/.cabal/bin"
libdir     = "/Users/a123/.cabal/lib/aarch64-osx-ghc-9.10.3-fe9c/dtmc-0.1.0.0-inplace"
dynlibdir  = "/Users/a123/.cabal/lib/aarch64-osx-ghc-9.10.3-fe9c"
datadir    = "/Users/a123/.cabal/share/aarch64-osx-ghc-9.10.3-fe9c/dtmc-0.1.0.0"
libexecdir = "/Users/a123/.cabal/libexec/aarch64-osx-ghc-9.10.3-fe9c/dtmc-0.1.0.0"
sysconfdir = "/Users/a123/.cabal/etc"

getBinDir     = catchIO (getEnv "dtmc_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "dtmc_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "dtmc_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "dtmc_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "dtmc_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "dtmc_sysconfdir") (\_ -> return sysconfdir)
